...
label_topo = tk.Label(frame_topo, text="Frame superior", bg="lightblue", font=("Arial Bold", 16))
...
label_meio = tk.Label(frame_meio, text="Frame do meio", bg="lightgreen", font=("Arial Bold", 16))
...
label_baixo = tk.Label(frame_baixo, text="Frame inferior", bg="yellow", font=("Arial bond", 16))
